...
class Header extends Component {
  render() {
    if(this.props.data){
        var bussines = this.props.data.bussines;
    ...
    return (
      ...
      <nav id="nav-wrap">
         ...
         <a className="mobile-btn" href="#nav-wrap" title="Show navigation">Mostrar navegación</a>
	      <a className="mobile-btn" href="" title="Hide navigation">Ocultar navegación</a>

         <ul id="nav" className="nav">
            <li className="current"><a className="smoothscroll" href="#home">Inicio</a></li>
            <li><a className="smoothscroll" href="#about">Acerce de mi</a></li>
	         <li><a className="smoothscroll" href="#resume">Resumen</a></li>
            <li><a className="smoothscroll" href="#portfolio">Mis trabajos</a></li>
      ...
      <div className="row banner">
         <div className="banner-text">
            <h1 className="responsive-headline">{bussines}</h1>
